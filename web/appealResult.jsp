...
<head>
    ...
    <title>Appeal Status - Polytechnic Hostel</title>
    <!-- Boxicons -->
        ...
        <main class="main-content">
            <div class="status-container">
                ...
                <div class="status-info">
                    <c:if test="${not empty sessionScope.appealID}">
                        <p class="appeal-id">Appeal ID: ${sessionScope.appealID}</p>
                    </c:if>
                ...
                <div class="status-message 
                    <c:choose>
                        <c:when test="${appealStatus == 'APPROVED'}">status-approved</c:when>
                        <c:when test="${appealStatus == 'REJECTED'}">status-rejected</c:when>
